...
for instance in controller-0 controller-1 controller-2; do
  ...
  vagrant ssh ${instance} -c "cd /home/vagrant && tar -xvf etcd-v3.4.15-linux-amd64.tar.gz && sudo chown -R root: etcd-* && sudo cp etcd-v3.4.15-linux-amd64/etcd* /usr/local/bin/"
done
